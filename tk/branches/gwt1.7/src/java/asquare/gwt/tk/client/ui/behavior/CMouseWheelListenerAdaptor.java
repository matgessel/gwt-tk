...
public class CMouseWheelListenerAdaptor extends MouseWheelListenerCollection implements Controller
{
	...
	public static void addListener(ControllerSupport widget, MouseWheelListener listener)
	{
		CMouseWheelListenerAdaptor controller = (CMouseWheelListenerAdaptor) widget.getController(CMouseWheelListenerAdaptor.class);
		if (controller == null)
		{
			controller = new CMouseWheelListenerAdaptor();
			widget.addController(controller);
		}
		controller.add(listener);
	}
	
	public static void removeListener(ControllerSupport widget, MouseWheelListener listener)
	{
		CMouseWheelListenerAdaptor controller = (CMouseWheelListenerAdaptor) widget.getController(CMouseWheelListenerAdaptor.class);
		if (controller != null)
		{
	...
	{
		fireMouseWheelEvent(widget, event);
	}
}
