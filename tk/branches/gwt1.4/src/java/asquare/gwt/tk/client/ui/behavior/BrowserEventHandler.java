...
/**
 * A BrowserEventHandler processes events from a widget.
 * <p>
 ...
 * without autoclose). A solution is to have the widget delegate events to a
 * focus manager implementing BrowserEventHandler.
 * </p>
 */
public interface BrowserEventHandler extends EventInterest
{
	/**
