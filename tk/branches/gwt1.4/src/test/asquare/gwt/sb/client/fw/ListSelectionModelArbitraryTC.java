...
public class ListSelectionModelArbitraryTC extends TestCase
{
	...
	public void testGetAnchorIndex()
	{
		// initial state
		setupImpl();
	...
	public void testAddSelectionRange()
	{
		...
		// bug: model range is modified by change event
		setupImpl();
		m_model.setSelectionRange(0, 0);
		m_model.addListener(m_l1);
		m_model.setSelectionRange(0, 1);
		assertEquals(0, m_l1.getDeselectedRanges().getSize());
	...
	public void testRemoveSelectionRange()
	{
		...
		// anchor & lead indices updated
		setupImpl();
		m_model.setSelectionRange(0, 6);
		m_model.removeSelectionRange(5, 7);
		assertEquals(5, m_model.getAnchorIndex());
		assertEquals(7, m_model.getLeadIndex());
		m_model.removeSelectionRange(6, 4);
		assertEquals(6, m_model.getAnchorIndex());
		assertEquals(4, m_model.getLeadIndex());
		m_model.removeSelectionRange(1, 2);
		assertEquals(1, m_model.getAnchorIndex());
	...
	public void testSetSelectionRange()
	{
		...
		// anchor & lead indices updated
		setupImpl();
		m_model.setSelectionRange(2, 4);
		assertEquals(2, m_model.getAnchorIndex());
		assertEquals(4, m_model.getLeadIndex());
		m_model.setSelectionRange(5, 1);
		assertEquals(5, m_model.getAnchorIndex());
		assertEquals(1, m_model.getLeadIndex());
...
//	}
	...
	public void testAdjustForItemsInserted()
	{
		...
		// anchor & lead indices updated
		// Note: unsure of expected behavior
		setupImpl();
		m_model.setSelectionRange(2, 4);
		m_model.adjustForItemsInserted(2, 1);
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(5, m_model.getLeadIndex());
		m_model.adjustForItemsInserted(4, 1);
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(6, m_model.getLeadIndex());
		m_model.adjustForItemsInserted(6, 1);
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(7, m_model.getLeadIndex());
		m_model.adjustForItemsInserted(8, 1);
		assertEquals(3, m_model.getAnchorIndex());
	...
	public void testAdjustForItemsRemoved()
	{
		...
		// Note: unsure of expected behavior
		setupImpl();
		m_model.setSelectionRange(3, 7);
		m_model.adjustForItemsRemoved(8, 1);
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(7, m_model.getLeadIndex());
		m_model.adjustForItemsRemoved(7, 1);
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(7, m_model.getLeadIndex());
		m_model.adjustForItemsRemoved(4, 1);
		assertEquals(3, m_model.getAnchorIndex());
		...
		assertEquals(3, m_model.getAnchorIndex());
		assertEquals(5, m_model.getLeadIndex());
		m_model.adjustForItemsRemoved(2, 10);
		assertEquals(-1, m_model.getAnchorIndex());
		assertEquals(-1, m_model.getLeadIndex());
	}
}
