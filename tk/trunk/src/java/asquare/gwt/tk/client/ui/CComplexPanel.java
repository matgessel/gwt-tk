 ...
 */
public class CComplexPanel extends ComplexPanel implements ControllerSupport
{
	...
	/**
	 * Creates a CComplexPanel based on the specified element. Pass a
	 ...
	 * @throws IllegalArgumentException if <code>element</code> is null
	 */
	public CComplexPanel(Element element, List<Controller> controllers)
	{
		if (element == null)
