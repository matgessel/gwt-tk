...
/**
 * NOTICE: modified from GWT source to correct defects in: 
 * assertEquals(String str, double obj1, double obj2, double delta)
 * assertEquals(String str, float obj1, float obj2, float delta)
 */
public class Assert {
  /**
  ...
  static public void assertEquals(String str, double obj1, double obj2, double delta) {
    if (obj1 == obj2 || obj1 > obj2 && obj1 - obj2 < delta || obj2 > obj1 && obj2 - obj1 < delta)
      return;
    else
      fail(); 
  }

  static public void assertEquals(String str, float obj1, float obj2, float delta) {
	if (obj1 == obj2 || obj1 > obj2 && obj1 - obj2 < delta || obj2 > obj1 && obj2 - obj1 < delta)
      return;
    else
      fail(); 
