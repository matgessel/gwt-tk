 ...
 * </ul>
 */
public class CTabBar extends ListViewDefault
{
	public CTabBar()
	{
		this(new ListWidgetHTable(), null, null);
	}
	
	public CTabBar(ListWidget structure, List controllers, ModelElementFormatter formatter)
	{
	...
	{
		GwtUtil.rangeCheck(1, getSize(), index + 1, false);
		super.formatCell(index + 1, item, cellProperties);
	}
}
